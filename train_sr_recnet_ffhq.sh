...
CHECKPOINT_DIR="./checkpoints/$NAME" OPENAI_LOGDIR="./output/$NAME" python super_res_train.py --data_dir /data/FFHQ/images1024x1024 $MODEL_FLAGS $TRAIN_FLAGS --use_recnet True --path_recnet ../recnet_lsunhorse_40000.pth
