NAME="imagenet64x64_sr256_recnet"
...
CHECKPOINT_DIR="./checkpoints/$NAME" OPENAI_LOGDIR="./output/$NAME" python super_res_train.py --data_dir /data/common/ILSVRC/Data/CLS-LOC/train $MODEL_FLAGS $TRAIN_FLAGS --use_recnet True --path_recnet ../recnet_lsunhorse_40000.pth
